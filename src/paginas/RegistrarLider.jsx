...
const RegistrarLider = () => {
    ...
    const handleSubmit = async e => {
        ...
        try {
            await clienteAxios.post("/lideres/admin", { nombre, email, password, telefono });
            setAlerta({
    ...
    return (
        <>
            <div>
                <h1 className="text-indigo-600 font-black text-6xl">Registrate Como Lider <span className="text-black"> Delega & Administra las Tareas</span></h1>
            </div>
                ...
                <div className="flex justify-between my-5 ">
                    ...
                    <Link to="/registrar">
                        <input 
                            ...
                            className="bg-slate-900 w-full transition-transform py-3 px-6 text-white rounded-l-xl font-bold mt-5 hover:cursor-pointer hover:bg-indigo-600"
                        />
                    </Link>
                    <input  
                    type="button"
                    value="Registrate como Lider"
                    className="w-full py-3 px-6 bg-slate-200 rounded-r-xl font-black mt-5"
                    />
                </div>
